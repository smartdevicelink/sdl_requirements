...
5. SDL sends OnRCStatus to HMI and to registered application app1 and app2 with module_1 in section `allocatedModules` and remained modules in `freeModules`  
