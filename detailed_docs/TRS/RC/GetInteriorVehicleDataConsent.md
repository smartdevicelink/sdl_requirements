...
- and RC application requested access to remote control module that is already allocated to another RC application
- and SDL requested user consent from HMI via GetInteriorVehicleDataConsent
- and user did not provide answer during default timeout
- and SDL received from HMI response GetInteriorVehicleDataConsent (TIMED_OUT)
...
- not allocate access for remote control module to requested application (meaning SDL must leave control of remote control module without changes)
